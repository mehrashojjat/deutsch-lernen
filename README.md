...
│   ├── adaptive.js          # Adaptive quiz engine (per-level A1/A2/B1)
...
Signed-in users store Adaptive V2 progress in Supabase under `user_progress.level = 'ALL'`, parallel to legacy `A1` / `A2` / `B1` rows.
