...
const UI = {
  en: {
    ...
    errFileProtocol: ' Run npm run dev from the repo root (http://localhost:3000), not file://.',
  ...
  de: {
    ...
    errFileProtocol: ' npm run dev im Repo-Root ausführen (http://localhost:3000), nicht file://.',
  ...
  tr: {
    ...
    errFileProtocol: ' Repo kökünden npm run dev çalıştırın (http://localhost:3000), file:// değil.',
  ...
  fa: {
    ...
    errFileProtocol: ' npm run dev را از ریشهٔ مخزن اجرا کنید (http://localhost:3000)، نه file://.',
  ...
  ru: {
    ...
    errFileProtocol: ' Запустите npm run dev из корня репозитория (http://localhost:3000), а не file://.',
  ...
  uk: {
    ...
    errFileProtocol: ' Запустіть npm run dev з кореня репозиторію (http://localhost:3000), а не file://.',
    adaptiveV2Badge: 'Адаптив V2',
  ...
  ar: {
    ...
    errFileProtocol: ' شغّل npm run dev من جذر المستودع (http://localhost:3000)، وليس file://.',
