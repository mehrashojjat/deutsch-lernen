...
const UI = {
  en: {
    ...
    adaptiveV2BannerTitle: 'Adaptive Quiz',
    ...
    rushCalMessage: 'Complete your level assessment in Adaptive Quiz before starting Rush Mode.',
  ...
  de: {
    ...
    footerCopy: '© 2026 Mehras Hojjat',
    adaptiveV2BannerTitle: 'Adaptives Quiz',
    ...
    rushCalMessage: 'Schließe zuerst die Niveubestimmung im Adaptiven Quiz ab, bevor du den Rush-Modus startest.',
  ...
  tr: {
    ...
    footerCopy: '© 2026 Mehras Hojjat',
    adaptiveV2BannerTitle: 'Uyarlamalı Sınav',
    ...
    rushCalMessage: 'Rush Moduna başlamadan önce Uyarlamalı Sınav ile seviye belirlemesini tamamla.',
  ...
  fa: {
    ...
    adaptiveV2BannerTitle: 'آزمون تطبیقی',
    ...
    rushCalMessage: 'قبل از شروع حالت راش، ارزیابی سطح را در آزمون تطبیقی کامل کن.',
  ...
  ru: {
    ...
    footerCopy: '© 2026 Mehras Hojjat',
    adaptiveV2BannerTitle: 'Адаптивная викторина',
    ...
    rushCalMessage: 'Сначала пройдите оценку уровня в Адаптивной викторине, затем начните Rush.',
  ...
  uk: {
    ...
    footerCopy: '© 2026 Mehras Hojjat',
    adaptiveV2BannerTitle: 'Адаптивна вікторина',
    ...
    rushCalMessage: 'Спочатку пройдіть оцінку рівня в Адаптивній вікторині, потім запускайте Rush.',
  ...
  ar: {
    ...
    footerCopy: '© 2026 Mehras Hojjat',
    adaptiveV2BannerTitle: 'اختبار تكيّفي',
    ...
    rushCalMessage: 'أكمل تقييم مستواك في الاختبار التكيّفي قبل بدء وضع راش.',
...
const PROFILE_I18N = {
  en: {
    ...
    resetAdaptiveConfirm: 'Reset all Adaptive Quiz progress? This deletes your word history, skill level, and calibration. This cannot be undone.',
  ...
  de: {
    ...
    resetAdaptiveConfirm: 'Gesamten Fortschritt im Adaptiven Quiz zurücksetzen? Wortverlauf, Niveau und Kalibrierung werden gelöscht. Das kann nicht rückgängig gemacht werden.',
  ...
  tr: {
    ...
    resetAdaptiveConfirm: 'Tüm Uyarlamalı Sınav ilerlemesini sıfırla? Kelime geçmişi, seviye ve kalibrasyon silinir. Bu geri alınamaz.',
  ...
  fa: {
    ...
    resetAdaptiveConfirm: 'همهٔ پیشرفت آزمون تطبیقی بازنشانی شود؟ تاریخچهٔ واژه‌ها، سطح و کالیبراسیون حذف می‌شود. این کار برگشت‌پذیر نیست.',
  ...
  ru: {
    ...
    resetAdaptiveConfirm: 'Сбросить весь прогресс Адаптивной викторины? История слов, уровень и калибровка будут удалены. Это нельзя отменить.',
  ...
  uk: {
    ...
    resetAdaptiveConfirm: 'Скинути весь прогрес Адаптивної вікторини? Історія слів, рівень і калібрування будуть видалені. Це не можна скасувати.',
  ...
  ar: {
    ...
    resetAdaptiveConfirm: 'إعادة تعيين كل تقدم الاختبار التكيّفي؟ سيتم حذف سجل الكلمات والمستوى والمعايرة. لا يمكن التراجع عن ذلك.',
